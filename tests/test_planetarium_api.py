...
def sample_show_session(**params):
    planetarium_dome = PlanetariumDome.objects.create(
        name="Sample planetarium", rows=20, seats_in_row=20
    )
...
class AuthenticatedAstronomyShowApiTests(TestCase):
    ...
    def test_astronomy_show_list_filter_by_title(self):
        astronomy_show1 = sample_astronomy_show(title="AstronomyShow11")
        astronomy_show2 = sample_astronomy_show(title="AstronomyShow12")
        astronomy_show3 = sample_astronomy_show(title="AstronomyShow21")

        res = self.client.get(ASTRONOMY_SHOW_URL, {"title": "2"})
    ...
    def test_astronomy_show_list_filter_by_themes(self):
        astronomy_show1 = sample_astronomy_show(title="AstronomyShow1")
        astronomy_show2 = sample_astronomy_show(title="AstronomyShow12")
        astronomy_show3 = sample_astronomy_show(title="AstronomyShow21")

        theme1 = sample_theme()
        theme2 = sample_theme(name="Comedy")
